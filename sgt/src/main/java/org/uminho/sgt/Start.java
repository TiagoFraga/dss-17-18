...
public class Start {
  ...
  public static void main(String[] args) {
    UnidadeCurricular u1 =
        new UnidadeCurricular("HN1", "Desenvolvimento de Sistemas de Software", "DSS", 3);
    ...
    HashMap<UnidadeCurricular, ArrayList<Turno>> cadeiras8 =
        new HashMap<UnidadeCurricular, ArrayList<Turno>>();
    Professor a9 = new Professor(false, "Creissac", 8, "Jose Creissac", "pg8@uminho.pt", "putas");
    HashMap<UnidadeCurricular, ArrayList<Turno>> cadeiras9 =
        new HashMap<UnidadeCurricular, ArrayList<Turno>>();
    Professor a10 =
        new Professor(false, "JBB", 9, "Jose Bernardo Barros", "pg9@uminho.pt", "putas");
    HashMap<UnidadeCurricular, ArrayList<Turno>> cadeiras10 =
        new HashMap<UnidadeCurricular, ArrayList<Turno>>();
    Professor a11 =
        new Professor(false, "JNO", 10, "Jose Nuno Oliveira", "pg10@uminho.pt", "putas");
    HashMap<UnidadeCurricular, ArrayList<Turno>> cadeiras11 =
        new HashMap<UnidadeCurricular, ArrayList<Turno>>();
    Professor a12 = new Professor(false, "VFF", 11, "Vitor Fontes", "pg11@uminho.pt", "putas");
    HashMap<UnidadeCurricular, ArrayList<Turno>> cadeiras12 =
        new HashMap<UnidadeCurricular, ArrayList<Turno>>();
