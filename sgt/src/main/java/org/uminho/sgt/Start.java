...
public class Start {
  ...
  public static void main(String[] args) {
   ...
   private void generateDatabaseData() {
    ...
    userDao.addStudent("65742@alunos.uminho.pt", "Miguel Esteves", "12345678", true);
    userDao.addStudent("12345@alunos.uminho.pt", "Joaquim Teixeira", "abcdefghi", false);
    userDao.addStudent("44567@alunos.uminho.pt", "Estrela Joana", "zxyzd614234", false);
    userDao.addStudent("56192@alunos.uminho.pt", "Rosa Cristiana", "12345678", true);
    userDao.addStudent("23546@alunos.uminho.pt", "Cristina Rodrigues", "1234lel5678", false);
    userDao.addStudent("36735@alunos.uminho.pt", "Luis Jorge", "12345678", true);
    ...
    subjectDao.addSubject("mieipi", "Programação Imperativa", "PI", "MIEI", "bachelor", 1, "jbb@uminho.pt");
    subjectDao.addSubject("mieidss","Desenvolvimento de Sistemas de Software","DSS","MIEI","bachelor",3,"creissac@uminho.pt");
    subjectDao.addSubject("mieibd", "Bases de dados", "BD", "MIEI", "bachelor", 3, "belo@uminho.pt");
    subjectDao.addSubject("mieicp", "Cálculo de Programas", "CP", "MIEI", "bachelor", 2, "jno@uminho.pt");

    logger.info("Creating shifts...");shiftDao.addShift("tp1","mieipi","TP","CP1-310",60,30,"monday","10:00:00","12:00:00","frade@uminho.pt");
    shiftDao.addShift("tp2","mieipi","TP","CP1-310",60,30,"tuesday","10:00:00","12:00:00","jbb@uminho.pt");
    shiftDao.addShift("tp3","mieipi","TP","CP1-310",60,30,"wednesday","10:00:00","12:00:00","creissac@uminho.pt");

    shiftDao.addShift("tp1","mieidss","TP","CP1-310",60,30,"wednesday","10:00:00","12:00:00","creissac@uminho.pt");
    shiftDao.addShift("tp2","mieidss","TP","CP1-310",60,30,"thursday","10:00:00","12:00:00","nestor@uminho.pt");

    shiftDao.addShift("tp1","mieibd","TP","CP1-310",60,30,"wednesday","10:00:00","12:00:00","jno@uminho.pt");
    shiftDao.addShift("tp2","mieibd","TP","CP1-310",60,30,"wednesday","10:00:00","12:00:00","creissac@uminho.pt");
    shiftDao.addShift("tp3","mieibd","TP","CP1-310",60,30,"wednesday","10:00:00","12:00:00","creissac@uminho.pt");
