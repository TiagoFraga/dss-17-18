 ...
 * @author cp74
 */
public class AAInicio1 extends javax.swing.JFrame{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ABLogin2 novaJanela = new ABLogin2();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AAInicio1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
